...
public class OrangeJuiceFluidType extends FluidType {
    ...
    public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
        consumer.accept(new IClientFluidTypeExtensions() {
            private static final ResourceLocation STILL_TEXTURE = ResourceLocation.fromNamespaceAndPath("fruitydelight", "block/orange_juice_fluid_still");
            private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.fromNamespaceAndPath("fruitydelight", "block/orange_juice_fluid_flow");
